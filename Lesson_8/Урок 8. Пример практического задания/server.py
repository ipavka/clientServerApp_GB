...
from common_.variables import DEFAULT_PORT, MAX_CONNECTIONS, ACTION, TIME, \
    USER, ACCOUNT_NAME, SENDER, PRESENCE, ERROR, MESSAGE, \
    MESSAGE_TEXT, RESPONSE_400, DESTINATION, RESPONSE_200, EXIT
from common_.utils import get_message, send_message
...
def process_client_message(message, messages_list, client, clients, names):
    ...
    if (ACTION in message
        ...
        if message[USER][ACCOUNT_NAME] not in names.keys():
            ...
            # print(names[message[USER][ACCOUNT_NAME]])
