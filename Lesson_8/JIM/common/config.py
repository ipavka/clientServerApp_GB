...
RECIPIENT = data_file['jit_key'].get('RECIPIENT')
...
EXIT = data_file['other_key'].get('EXIT')
...
# Подсказка команд
MANUAL = f"Поддерживаемые команды:\n" \
         f"m - отправить сообщение\n" \
         f"h - вывести подсказки по командам\n" \
