...
try:
    ...
    with open('test_file.txt', 'rb') as file_br:
        for line_rb in file_br:
            res = chardet.detect(line_rb)
            print(line_rb.decode(res['encoding']))  # win-1251
            print(line_rb.decode(res['encoding']).encode('utf-8').decode('utf-8'))  # в utf-8
